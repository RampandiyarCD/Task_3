...
function ifwrong(element, errorElement) {
    ...
    element.classList.remove('border-red-500', 'focus:border-red-500', 'focus:ring-red-500', 'border-green-500', 'focus:border-green-500', 'focus:ring-green-500');
    element.classList.add('border-gray-300', 'focus:border-[#0087A5]', 'focus:ring-[#0087A5]');
}
...
form.addEventListener('submit', (e) => {
    ...
    if (isValid) {
        const user = usersData.find(u => u.login_id === username && u.password === password);
